...
import { SITE, AUTO_INSURANCE_CONSTANTS, getAgeComparison, formatCurrency } from "../site-config";
        ...
        <div className="min-h-screen bg-slate-50">
            <header className="bg-white border-b border-slate-200 sticky top-0 z-10 shadow-sm">
                <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-lg font-bold text-slate-800">Rates by Age</span>
                    </div>
                </div>
            </header>
            ...
            <main className="max-w-2xl mx-auto px-4 py-8">
                ...
                <div className="text-center">
                    <Link href="/calculator" className="inline-flex items-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold">
                        Calculate Your Rate →
                    </Link>
                </div>
            </main>
