...
import { SITE, CALCULATORS, AUTO_INSURANCE_CONSTANTS, formatCurrency, getCheapestStates, getMostExpensiveStates } from "./site-config";
        ...
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm text-slate-400 text-center">
              For informational purposes only. Actual rates may vary.
            </p>
